                    ...
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <img src="{{ $row->product_galleries()->exists() ? url('storage/product/gallery', $row->product_galleries->first()->image) : 'data:image/png;base64,iVBORw0KGoAAAANSUhEUgAAAABCAQAAAC0lEQVR42mN88B8AASUB4ZtvXtIAAAAASUVORK5CYII=' }}"
