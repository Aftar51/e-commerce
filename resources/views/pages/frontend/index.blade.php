                ...
                @foreach ($product as $item)
                    <div class="px-4 relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                            ...
                            <img src="{{ $item->product_galleries()->exists() ? url('storage/product/gallery', $item->product_galleries->first()->image) : 'data:image/png;base64,iVBORw0KGoAAAANSUhEUgAAAABCAQAAAC0lEQVR42mN88B8AASUB4ZtvXtIAAAAASUVORK5CYII=' }}" alt="{{ $item->name }}"
